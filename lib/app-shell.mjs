const NAVIGATION_ITEMS = [
  ...
  { id: 'identity', label: '身份配置', href: 'options.html#identity' },
  { id: 'promotion', label: '推广网站', href: 'options.html#promotion' },
  { id: 'history', label: '评论历史', href: 'history.html' },
  { id: 'settings', label: '设置', href: 'options.html#settings' }
];
...
function currentNavigationId(currentUrl) {
  ...
  if (page === 'options.html') {
    ...
    return ['identity', 'promotion', 'settings'].includes(section) ? section : 'settings';
  }
  return page === 'history.html' ? 'history' : 'batch';
}
