...
const SAFE_ERROR_MESSAGES = Object.freeze({
  invalid_config_bundle_json: 'JSON 格式无效',
  invalid_config_bundle_format: '配置文件格式无效',
  unsupported_config_bundle_version: '配置文件版本不受支持',
  sensitive_config_bundle_field: '配置文件包含敏感字段',
  sensitive_config_bundle_url: '配置文件包含敏感 URL 参数',
  invalid_config_bundle_llm: '模型公开配置无效',
  invalid_config_bundle_batch_defaults: '批处理默认设置无效',
  invalid_config_bundle_preferences: '界面偏好设置无效',
  stale_config_bundle_preview: '导入预览已过期，请重新选择文件',
  config_bundle_apply_failed: 'config_bundle_apply_failed',
  config_bundle_rollback_failed: 'config_bundle_rollback_failed',
  PERMISSION_DENIED: '未授予模型 API 域名访问权限',
  PERMISSION_UNAVAILABLE: '模型 API 权限服务不可用'
});
...
function messageFor(error) {
  ...
  return SAFE_ERROR_MESSAGES[stableCode] || '未知错误，请重试';
}
